...
package com.example.rbac.framework.log.aop;

import com.alibaba.fastjson.JSONObject;
import com.auth0.jwt.exceptions.JWTDecodeException;
import com.baomidou.mybatisplus.core.toolkit.IdWorker;
import com.example.rbac.config.constant.CommonConstant;
import com.example.rbac.config.properties.SpringBootPlusAopProperties;
import com.example.rbac.framework.common.api.ApiCode;
import com.example.rbac.framework.common.api.ApiResult;
import com.example.rbac.framework.common.bean.ClientInfo;
import com.example.rbac.framework.common.exception.SpringBootPlusException;
...
import com.example.rbac.framework.log.annotation.OperationLogIgnore;
import com.example.rbac.framework.log.bean.OperationLogInfo;
import com.example.rbac.framework.log.bean.RequestInfo;
import com.example.rbac.framework.log.entity.SysLoginLog;
import com.example.rbac.framework.log.entity.SysOperationLog;
import com.example.rbac.framework.log.service.SysLoginLogService;
import com.example.rbac.framework.log.service.SysOperationLogService;
import com.example.rbac.framework.shiro.service.LoginToken;
import com.example.rbac.framework.shiro.service.LoginUsername;
import com.example.rbac.framework.shiro.util.JwtTokenUtil;
import com.example.rbac.framework.shiro.util.JwtUtil;
import com.example.rbac.framework.util.*;
        ...
        try {
            ...
            if (flag) {
                ...
                if (result != null && result instanceof ApiResult) {
                    ...
                    sysLoginLog.setCode(apiResult.getCode());
