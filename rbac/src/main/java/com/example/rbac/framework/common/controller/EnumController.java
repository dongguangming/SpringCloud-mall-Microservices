...
public class EnumController extends BaseController {
    ...
    private static final List<String> FRAMEWORK_ENUM_PACKAGES = Arrays.asList(
            "com.example.rbac.framework.common.enums",
            "com.example.rbac.system.enums");
        ...
        try {
            ...
            for (Class<? extends BaseEnum> clazz : set) {
                ...
                for (BaseEnum baseEnum : enumConstants) {
                    ...
                    EnumVo<BaseEnum> enumVo = new EnumVo.Builder().addCode(code)
                    		.addDesc(desc).addBaseEnum(baseEnum).buildCreatePattern();
