...
import com.example.rbac.config.properties.SpringBootPlusCorsProperties;
...
public class SpringBootPlusCorsConfig {
  	...
  	private static final Logger log = LoggerFactory.getLogger(SpringBootPlusCorsConfig.class);  
