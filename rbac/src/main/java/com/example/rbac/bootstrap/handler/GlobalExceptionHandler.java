...
package com.example.rbac.bootstrap.handler;
...
import com.example.rbac.framework.core.bean.RequestDetail;
import com.example.rbac.framework.core.util.RequestDetailThreadLocal;
import com.example.rbac.system.exception.SysLoginException;
...
public class GlobalExceptionHandler {
    ...
    public ApiResult<Boolean> springBootPlusExceptionHandler(SpringBootPlusException exception) {
        ...
        return new ApiResult.Builder().addCode(errorCode).addMessage(exception.getMessage()).buildCreatePattern();
    }
