...
import com.example.rbac.framework.common.exception.DaoException;
...
import com.example.rbac.system.entity.SysRolePermission;
import com.example.rbac.system.enums.StateEnum;
import com.example.rbac.system.mapper.SysRoleMapper;
import com.example.rbac.system.param.sysrole.SysRolePageParam;
import com.example.rbac.system.param.sysrole.UpdateSysRolePermissionParam;
import com.example.rbac.system.service.SysPermissionService;
...
import com.example.rbac.system.vo.SysRoleQueryVo;
...
public class SysRoleServiceImpl extends BaseServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    public SysRoleQueryVo getSysRoleById(Serializable id) throws Exception {
        ...
        List<Object> permissionIds = sysRolePermissionService.getPermissionIdsByRoleId((Long) id);
        List<Long> beforeIdList = new ArrayList<>();
        permissionIds.forEach(item->
        beforeIdList.add(Long.valueOf(String.valueOf(item)))
        );
        sysRoleQueryVo.setPermissions(new HashSet<>(beforeIdList));
    ...
    public boolean updateSysRolePermission(UpdateSysRolePermissionParam param) throws Exception {
        ...
        // 获取之前的权限id集合
        List<Object> beforeList = sysRolePermissionService.getPermissionIdsByRoleId(roleId);
        List<Long> beforeIdList = new ArrayList<>();
        ...
        Set<Long> beforeSet = new HashSet<>(beforeIdList);
