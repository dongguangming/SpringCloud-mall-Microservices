...
package com.example.rbac.system.controller;
...
public class LoginController {
    ...
    @PostMapping("/login")
    @OperationLogIgnore
    @ApiOperation(value = "登录", notes = "系统用户登录", response = com.example.rbac.system.vo.LoginSysUserTokenVo.class)
    public ApiResult<LoginSysUserTokenVo> login(@Validated @RequestBody com.example.rbac.system.param.LoginParam loginParam, HttpServletResponse response) throws Exception {
